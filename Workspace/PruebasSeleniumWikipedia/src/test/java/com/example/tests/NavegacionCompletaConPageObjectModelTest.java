...
public class NavegacionCompletaConPageObjectModelTest {
	...
	public void testNavegacionCompleta() throws Exception {
		...
		HtmlPage htmlPage = new HtmlPage(driver, baseUrl);
		
		//Inicializa el objeto pagina
		htmlPage.get();
		
		//Hacemos uso de los requisotos de la pagina
		
		//Primera interaccion
		htmlPage.navegarPaginaHtmlForm();
		
		
		//Segunda interaccion
		htmlPage.navegarPaginaHtmlFormElements();
